  ...
  <div v-if="isOpen" class="modal">
    <div class="modal">
      ...
      <form @submit.prevent="save">
        ...
        <input name="sex" type="radio" v-model="formState.selectedSex" value="0"><b> Любой </b><br>
        <h3>Рассылка именинникам:</h3>
        <input name="birthday" type="radio" v-model="formState.onlyBirthdayToday" value="0"><br>
        <h3>Рассылка друзьям именинника (лучше делать заблаговременно):</h3>
        <input name="birthday" type="radio" v-model="formState.onlyBirthdayFriends" value="0"><br>
